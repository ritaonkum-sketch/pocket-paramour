    ...
    const SCENARIOS = [
        ...
        },
        {
            ...
            choices: [
                ...
                { text: "Come to bed", effects: { bond: 15, affection: 5 }, emotion: "shy", response: "Come to. I. that's. *Adjusts spectacles* You mean to sleep. Obviously. I'll... consider it." },
        ...
        // ====================================================
        {
            ...
            character: 'noir',
            minAffection: 1,
            prompt: "I was someone else once. Before the seal. The name is gone. I do not chase it.",
            choices: [
                { text: "Do you want to remember?", effects: { bond: 12 }, emotion: "gentle", response: "Hmm. Some nights. Most nights he is a stranger who wore my face. I do not mourn him." },
                { text: "You're Noir now. That's who I know.", effects: { bond: 15, affection: 3 }, emotion: "love", response: "Noir. You say it as though it weighs something. From your mouth. Perhaps it does." },
                { text: "I'll help you find out", effects: { bond: 18 }, emotion: "vulnerable", response: "Digging in that ground is not safe. For either of us. ...I do not say no.", memoryKey: "digPast" }
            ]
        },
        {
            id: 'noir_seal',
            character: 'noir',
            minAffection: 2,
            prompt: "The seal burns today. It does that when I feel too much. A neat punishment, hm.",
            choices: [
                { text: "What does it seal?", effects: { bond: 15 }, emotion: "gentle", response: "Power. Memory. The thing I was. Were it to break, you would not care for what stepped out.", memoryKey: "askedAboutSeal" },
                { text: "Can I help?", effects: { bond: 18, affection: 3 }, emotion: "vulnerable", response: "No mortal has, in six hundred years. ...And yet. The pain dimmed when you came in. I do not know how." },
                { text: "Then feel less", effects: { bond: 8 }, emotion: "cheeky", response: "Hmm. If only. You are why it burns, Weaver. I would not undo a single ember." }
            ]
        },
        {
            id: 'noir_corruption',
            character: 'noir',
            minAffection: 2,
            prompt: "The corruption is not evil. It is hunger. For touch. For warmth. For what was kept from me.",
            choices: [
                { text: "I'm not afraid of it", effects: { bond: 18, affection: 3, corruption: 3 }, emotion: "love", response: "You should be. That you are not is either courage or a fine madness. Both will do.", memoryKey: "notAfraid" },
                { text: "Then let me feed it. With good things.", effects: { bond: 15, affection: 3, corruption: 2 }, emotion: "vulnerable", response: "Good things. For me. You would pour light into a hole and trust it to hold. ...It may." },
                { text: "Is it consuming you?", effects: { bond: 12 }, emotion: "sad", response: "Slowly. As tides do. You are the shore it breaks upon. You slow it." }
            ]
        },
        {
            id: 'noir_loneliness',
            character: 'noir',
            minAffection: 3,
            prompt: "Six hundred years in the dark. No voice. No hand. Only the seal and the quiet.",
            choices: [
                { text: "You're not alone anymore", effects: { bond: 20, affection: 5 }, emotion: "love", response: "...Again. Say it again. Once is not enough to believe a thing like that.", memoryKey: "notAloneAnymore" },
                { text: "How did you survive?", effects: { bond: 15 }, emotion: "gentle", response: "I did not. What went in did not come out. Something else stood up in its place. Something hungrier." },
                { text: "*Take his hand*", effects: { bond: 18, affection: 3, corruption: 2 }, emotion: "vulnerable", response: "...Cold. I am always cold. Your hand is... warm. Hold on. Do not let go." }
            ]
        },
        {
            ...
            character: 'noir',
            minAffection: 2,
            prompt: "There were others, once. Soul weavers. All gone now. Sealed. Or broken open.",
            choices: [
                { text: "What happened to them?", effects: { bond: 12 }, emotion: "sad", response: "They loved too deep. Or not at all. Both are fatal for our kind." },
                { text: "You survived. That means something.", effects: { bond: 15 }, emotion: "gentle", response: "It means I am stubborn. Or fortunate. Or I was waiting for a reason worth the wait.", memoryKey: "worthSurviving" },
                { text: "I won't let that happen to you", effects: { bond: 18, affection: 3, corruption: 2 }, emotion: "love", response: "A mortal guarding a soul weaver. The world keeps a strange ledger. ...I find I am grateful for the entry." }
            ]
        },
        {
            ...
            character: 'noir',
            minAffection: 1,
            prompt: "Most fear the dark. They have not watched shadows move. There is a beauty in the things they will not look at.",
            choices: [
                { text: "Show me", effects: { bond: 15, affection: 2, corruption: 2 }, emotion: "happy", response: "Watch. The shadows curl. They move like water. Like a song with no sound.", memoryKey: "sawShadowDance" },
                { text: "You're proof of that", effects: { bond: 18, affection: 5, corruption: 3 }, emotion: "love", response: "...You named the dark beautiful. You named me the same. I do not know where to put that. I will keep it." },
                { text: "I've never feared you", effects: { bond: 12 }, emotion: "gentle", response: "I know. It vexes me. It pleases me. It does both at once. You are an impossible thing." }
            ]
        },
        {
            id: 'noir_freedom',
            character: 'noir',
            minAffection: 3,
            prompt: "If the seal broke, I would be free. For a thing like me, free is another word for dangerous.",
            choices: [
                { text: "Would you still be you?", effects: { bond: 15 }, emotion: "vulnerable", response: "I do not know. The seal holds power. It holds memory also. Without it I might not remember this. You." },
                { text: "I'd stay either way", effects: { bond: 20, affection: 5, corruption: 3 }, emotion: "love", response: "Even were I a monster. Even were the dark to swallow the rest. ...You are lying, or you are mad. I hope you are mad.", memoryKey: "stayEitherWay" },
        ...
        },
        {
            ...
            character: 'noir',
            minAffection: 4,
            prompt: "Everyone I have trusted has sold me. Mortals. Weavers. Gods. And now I am trusting you.",
            choices: [
                { text: "I won't betray you", effects: { bond: 20, affection: 3 }, emotion: "love", response: "They all spoke those words. Your voice... the shadows go quiet for it. I choose to believe.", memoryKey: "trustedYou" },
                { text: "I know what that costs you", effects: { bond: 18 }, emotion: "vulnerable", response: "You do. Somehow, you do. That is mercy. Or witchcraft. With you I cannot tell them apart." },
                { text: "Then I'll earn it every day", effects: { bond: 15, affection: 5, corruption: 2 }, emotion: "love", response: "Every day. Not once. Not a vow and then silence. Every day. ...I will be watching. I will be hoping." }
            ]
        }
    ];
