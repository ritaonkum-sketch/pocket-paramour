      ...
      setTimeout(() => {
        ...
        options.forEach((opt) => {
          const btn = el('button', [
            ...
            'border:1px solid rgba(229,163,212,0.35)',
            'background:linear-gradient(180deg,rgba(40,20,44,0.94),rgba(24,12,28,0.94))',
            'color:#f8e9ff', 'font-size:15px', 'font-weight:500', 'line-height:1.4',
