...
(function () {
    ...
    // character arrays).
    // ────────────────────────────────────────────────────────────────
    // All 12 entries (11 crossovers + 1 encounter) were stripped June 2026
    // when the underlying scene files were deleted (owner cleanup ahead of
    // new main-story content). The array is kept (rather than removed) so
    // the CROSSOVERS.forEach / .filter call sites below continue to work
    // against an empty list. New crossover entries can be appended here
    // when new scene files are added.
    const CROSSOVERS = [];
    ...
    const SOUL_FRAGMENTS = [
        ...
        { char: 'elian', title: 'The Root',
          ...
          thumb: 'assets/elian/body/calm.png' },
        { char: 'proto', title: 'The Thread',
          text: "A flash of silver thread. Your summoning wasn’t random. Someone, something, chose you on purpose. The reason they chose you: your capacity for connection.",
