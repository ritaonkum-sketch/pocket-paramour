    ...
    const IDLE_SETS = {
        alistair: {
            behaviors: [
                ...
                { body: 'casual1',    face: 'gentle',   duration: 7000, thought: "It's quiet tonight." },
                { body: 'casual2',    face: 'neutral2', duration: 6000 },
                ...
                { body: 'casual3',    face: 'cheeky',   duration: 5000 },
        ...
        lucien: {
            behaviors: [
                ...
                { body: 'casual1',    face: 'amused',      duration: 4000, thought: "The equations don't account for you." },
                { body: 'bored1',     face: 'sleepy',      duration: 7000, thought: "When did it get this late?" },
                { body: 'curious',    face: 'vulnerable',  duration: 5000 },
                { body: 'casual2',    face: 'cheeky',      duration: 4000, thought: "I wrote your name in the margins again." },
            ],
        },
        caspian: {
            behaviors: [
                ...
                { body: 'casual1',    face: 'gentle',      duration: 5000, thought: "I should put the kettle on." },
                { body: 'casual2',    face: 'adoring',     duration: 4000 },
                ...
                { body: 'casual1',    face: 'adoring',     duration: 4000, thought: "Your cup is on the left. I remembered." },
            ],
        },
        elian: {
            behaviors: [
                ...
                { body: 'casual1',    face: 'warm',      duration: 5000 },
                ...
                { body: 'casual2',    face: 'warm',      duration: 4000, thought: "I carved something. It's not finished." },
            ],
        },
    };
