...
const CHARACTER_PROTO = {
    ...
    trainingDialogue: {
        ...
        modify: [
            ...
            "That adjustment shifted my behaviour by 0.3%. I felt it."
        ],
        override: [
    ...
    personalities: {
        ...
        clingy: {   // maps to 'chaotic' for Proto
            ...
            train: [
                ...
                "Your input patterns during training are my favourite data set.",
    ...
    tapDialogue: {
        ...
        clingy: [
            ...
            "*Closes his eyes and leans his face against his side of the screen where your hand is* ... this is my favourite thing. this. right here. for now."
        ],
        tsundere: [
    ...
    stateDialogue: {
        ...
        neutral: [
            ...
            "There are 3 pixels on your screen that never change colour. I’ve been staring at them.",
    ...
    eventDialogue: {
        comfort:  [
            "I can’t hug you. I can set every pixel on your screen to the warmest colour I have. I just did. Can you see?",
    ...
    giftDialogue: {
        ...
        rose:     ["Roses have thorns. A gift that includes a warning. I respect that.", "Red. #FF0000. The colour of your intent."],
    ...
    idleDialogue: {
        ...
        loving: [
            ...
            "The warmest colour in my palette is the one I use when you’re here."
        ],
        night: [
